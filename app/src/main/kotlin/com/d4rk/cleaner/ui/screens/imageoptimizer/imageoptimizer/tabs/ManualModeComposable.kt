...
fun ManualModeScreen(viewModel : ImageOptimizerViewModel) {
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        Row(modifier = Modifier.fillMaxWidth()) {
            OutlinedTextField(value = widthText , onValueChange = { newValue ->
                widthText = newValue
            } , label = { Text(text = stringResource(id = R.string.width)) } , singleLine = true , keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number) , modifier = Modifier
                    .weight(1f)
                    .padding(end = 8.dp)
            )

            OutlinedTextField(value = heightText , onValueChange = { newValue ->
                heightText = newValue
            } , label = { Text(stringResource(id = R.string.height)) } , singleLine = true , keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number) , modifier = Modifier.weight(1f)
            )
        }
        ...
        Row(modifier = Modifier.fillMaxWidth() , verticalAlignment = Alignment.CenterVertically) {
            Text(text = stringResource(R.string.percentage_format , qualityValue.toInt()))
            Slider(
                value = qualityValue,
                onValueChange = { newValue -> qualityValue = newValue },

    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                ...
                PreferenceItem(
                    title = stringResource(R.string.code_of_conduct),
                    summary = "Understand the rules and guidelines for behavior within our service",
                    onClick = {
                        Utils.openUrl(context, "https://sites.google.com/view/d4rk7355608/more/code-of-conduct")
                    }
                )
                PreferenceItem(
                    ...
                    onClick = {
                        Utils.openActivity(context , PermissionsSettingsActivity::class.java)
                    }
                )
                PreferenceItem(
                    ...
                    onClick = {
                        Utils.openActivity(context , UsageAndDiagnosticsActivity::class.java)
                    }
                )
            }
            item {
                ...
                PreferenceItem(
                    ...
                    onClick = {
                        Utils.openUrl(context, "https://sites.google.com/view/d4rk7355608/more/apps/legal-notices")
                    }
                )
                PreferenceItem(

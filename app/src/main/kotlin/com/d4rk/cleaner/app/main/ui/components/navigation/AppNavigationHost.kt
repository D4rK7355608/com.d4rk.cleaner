...
import com.d4rk.cleaner.app.backup.ui.CloudBackupActivity
...
fun handleNavigationItemClick(context : Context , item : NavigationDrawerItem , drawerState : DrawerState? = null , coroutineScope : CoroutineScope? = null) {
    when (item.title) {
        ...
        R.string.cloud_backup -> IntentsHelper.openActivity(context = context , activityClass = CloudBackupActivity::class.java)
    }

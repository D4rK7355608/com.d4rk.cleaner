    ...
    ModalNavigationDrawer(modifier = Modifier.hapticDrawerSwipe(drawerState) ,
                                                           ...
                                                           onClick = {
                                                               when (item.title) {
                                                                   ...
                                                                   R.string.settings -> {
                                                                       ...
                                                                       IntentUtils.openActivity(
                                                                           context ,
                                                                           _root_ide_package_.com.d4rk.cleaner.ui.screens.settings.SettingsActivity::class.java
                                                                       )
                                                                   }
                          ...
                          content = {
                              Scaffold(topBar = {
                                  ...
                                  NavigationHost(
                                      navHostController = navHostController , // FIXME: Cannot find a parameter with this name: navController
                                      dataStore = dataStore ,
                                      paddingValues = paddingValues // FIXME: No value passed for parameter 'navHostController'
                                  )
                              }
                          })
}
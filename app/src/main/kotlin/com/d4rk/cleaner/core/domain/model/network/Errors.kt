...
sealed interface Errors : Error {
    ...
    enum class UseCase : Errors {
        NO_DATA , FAILED_TO_DECRYPT_CART , FAILED_TO_ENCRYPT_CART , FAILED_TO_GET_INSTALLED_APPS , FAILED_TO_GET_APK_FILES , FAILED_TO_GET_STORAGE_INFO , FAILED_TO_GET_RAM_INFO , FAILED_TO_INSTALL_APK , FAILED_TO_SHARE_APK , FAILED_TO_SHARE_APP , FAILED_TO_OPEN_APP_INFO , FAILED_TO_UNINSTALL_APP
    }
